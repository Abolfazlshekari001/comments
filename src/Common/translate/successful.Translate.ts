export function Request_Was_Successful1(additional_info: any) {
  return {
    status_code: 201,
    code: 5000,
    message: {
...
export function Request_Was_Successful3(additional_info: any) {
  return {
    status_code: 201,
    code: 5000,
    message: {
...
export function Request_Was_Successful4(messegefa: string, messegeen: string) {
  return {
    status_code: 201,
    message: {
      fa: messegefa,
